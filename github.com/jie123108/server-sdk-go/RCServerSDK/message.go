 ...
 */
func (self *Message) PublishPrivate(fromUserId string, toUserId []string, message IMessage, pushContent string, pushData string, count string, verifyBlacklist int, isPersisted int, isCounted int, isIncludeSender int) (*CodeSuccessReslut, error) {

	// glog.Infof("xxxxxxxxx PublishPrivate init xxxxxxxxxxx")
	if fromUserId == "" {
	...
	if err != nil {
		glog.Infof("xxxxxxxxx ToJson failed! err: %v", err)
		return nil, err
	}
 ...
 *@return CodeSuccessReslut
 */
func (self *Message) PublishGroup(fromUserId string, toGroupId []string, txtMessage IMessage, pushContent string, pushData string, isPersisted int, isCounted int, isIncludeSender int) (*CodeSuccessReslut, error) {
	if fromUserId == "" {
		return nil, errors.New("Paramer 'fromUserId' is required")
	}
 ...
 *@return CodeSuccessReslut
 */
func (self *Message) PublishDiscussion(fromUserId string, toDiscussionId string, txtMessage IMessage, pushContent string, pushData string, isPersisted int, isCounted int, isIncludeSender int) (*CodeSuccessReslut, error) {
	if fromUserId == "" {
		return nil, errors.New("Paramer 'fromUserId' is required")
	}
 ...
 *@return CodeSuccessReslut
 */
func (self *Message) PublishChatroom(fromUserId string, toChatroomId []string, txtMessage IMessage) (*CodeSuccessReslut, error) {
	if fromUserId == "" {
		return nil, errors.New("Paramer 'fromUserId' is required")
	}
