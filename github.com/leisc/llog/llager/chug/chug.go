...
func convertLagerLog(lagerLog llager.LogFormat) (LogEntry, bool) {
	...
	var logErr error
	if lagerLog.LogLevel == llager.ERROR || lagerLog.LogLevel == llager.FATAL {
